    ...
    <div v-else-if="submittedOrder" class="card success-panel">
      ...
      <div class="success-details">
        ...
        <div class="success-detail">
          ...
          <span class="detail-value">{{ currencySymbol }}{{ submittedOrder.total_value.toLocaleString() }}</span>
        </div>
      </div>
        ...
        <div class="table-footer">
          ...
          >
            ...
            <span v-if="!submitting && selectedItems.length > 0">
              ({{ selectedItems.length }} item{{ selectedItems.length !== 1 ? 's' : '' }} · {{ currencySymbol }}{{ totalSelectedCost.toLocaleString() }})
            </span>
          </button>
        </div>
      </div>
