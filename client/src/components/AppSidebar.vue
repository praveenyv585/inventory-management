...
export default {
  ...
  setup(props, { emit }) {
    ...
    return { collapsed, mobileOpen, brandInitial, isActive, toggleCollapse, closeMobile, tooltip, showTooltip, hideTooltip }
  }
}
</script>
...
.nav-item.active { background: #1e3a5f; color: #ffffff; }
