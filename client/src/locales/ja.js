export default {
  ...
  restocking: {
    title: '補充プランナー',
    description: '予算を設定し、需要予測から優先順位付きの補充注文を生成します',
    budgetLabel: '利用可能予算',
    itemsSelected: '{count}件選択 · 合計{total}',
    noItemsSelected: 'この予算内に収まるアイテムはありません。予算を増やしてください。',
    allItems: '推奨アイテム一覧（{count}件）',
    placeOrder: '注文する',
    placing: '注文中...',
    overBudget: '予算超過',
    successTitle: '補充注文完了',
    successBody: 'が処理のために送信されました。',
